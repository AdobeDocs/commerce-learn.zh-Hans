...
了解Adobe Commerce Intelligence。 本教程概述了该工具、需要了解的一些命名惯例以及设置该工具的初始步骤。 Adobe Commerce Intelligence由三部分组成：数据源、数据仓库存储和报表&#x200B;。数据源通常是Adobe Commerce网站及其数据库&#x200B;。在Data Warehouse中运行报表查询，而不是直接在网站的数据库中运行&#x200B;。了解Adobe Commerce Intelligence的主要功能，例如功能板、量度和报告，并提供有关访问文档、创建支持工单和管理用户权限的信息。
