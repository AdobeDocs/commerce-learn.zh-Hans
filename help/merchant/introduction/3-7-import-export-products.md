...
[导入 —  [!DNL Commerce] 用户](https://docs.magento.com/user-guide/system/data-import.html)
[指南导出 —  [!DNL Commerce] 用户指南](https://docs.magento.com/user-guide/system/data-export.html)
