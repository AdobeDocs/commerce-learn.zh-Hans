...
前端，使用Headless实施的体验可以简化该过程。 Adobe的Edge Delivery Services可通过基于文档的创作增强性能并加快Launch启动时间，从而无需开发人员即可进行更改。 此外，还要评估现有PHP模块和第三方扩展，并考虑使用预建的App Builder模块来最大限度地减少自定义代码。 升级核心应用程序需要仔细规划，包括删除不必要的属性和评估自定义数据库表以简化数据迁移。 将Adobe Commerce与其他Adobe解决方案(如Adobe Journey Optimizer和Real-time CDP)集成可以进一步增强您的项目功能。
