---
title: 创建礼品卡产品
description: 了解如何使用REST API和商务管理员创建礼品卡产品。
kt: 14587
doc-type: video
audience: all
activity: use
...
- [从商务管理员创建礼品卡产品](https://experienceleague.adobe.com/docs/commerce-admin/catalog/products/types/product-gift-card-create.html){target="_blank"}
